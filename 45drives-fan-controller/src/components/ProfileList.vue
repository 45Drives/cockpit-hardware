  ...
  <div class="flex flex-col gap-6">
    <div class="grid grid-cols-2 gap-4">
      ...
      <div
        ...
        :key="profile.id"
        class="group flex flex-col gap-3 bg-white dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700 p-5 text-left hover:border-red-400 dark:hover:border-red-600 hover:shadow-md transition-all cursor-pointer"
      ...
      >
        ...
        <div class="flex flex-wrap gap-1.5">
          ...
          <span
            v-if="profile.autoMode"
            class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400"
          >
            Auto
          </span>
        </div>
...
const emit = defineEmits(["new-profile", "open-profile", "delete-profile"]);
