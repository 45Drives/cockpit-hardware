...
| Category | Vendors | Flash Tool |
|----------|---------|------------|
| HBA | Broadcom (9305, 9361, 9400, 9600, 9660) | storcli64, storcli2 |
| NIC | NVIDIA/Mellanox ConnectX-5, Broadcom NetXtreme, Intel E810 | mlxup, bnxtnvm, nvmupdate64e |
| NVMe | Micron 7400, 7450 | nvme-cli |
| HDD | Seagate Exos (X14–X24, 2X18) | SeaChest_Firmware |
