...
const _hoisted_1$1 = { class: "p-5 flex items-center bg-plugin-header font-redhat shadow-lg z-10" };
const _hoisted_2 = { class: "flex flex-row items-baseline basis-32 grow shrink-0" };
const _hoisted_3 = ["src"];
const _hoisted_4 = { class: "text-2xl" };
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("span", { class: "text-gray-800 dark:text-red-600" }, "Drives", -1);
const _hoisted_6 = { class: "flex basis-32 justify-end grow shrink-0" };
...
var FfdHeader = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render]]);
