...
ssh root@$TEST_SERVER_A "rm -rf /usr/share/cockpit/$COCKPIT_MODULE-vue"

echo "updating $COCKPIT_MODULE on $TEST_SERVER_A using rsync..."
rsync -a ./fakeroot/usr/share/cockpit/$COCKPIT_MODULE/ root@$TEST_SERVER_A:/usr/share/cockpit/$COCKPIT_MODULE-vue/

echo "copying udev rules"
ssh root@$TEST_SERVER_A "cp /usr/share/cockpit/$COCKPIT_MODULE-vue/udev/68-cockpit-45drives-disks.rules /usr/lib/udev/rules.d/68-cockpit-45drives-disks.rules"
...
ssh root@$TEST_SERVER_B "rm -rf /usr/share/cockpit/$COCKPIT_MODULE-vue"

echo "updating $COCKPIT_MODULE on $TEST_SERVER_B using rsync..."
rsync -a ./fakeroot/usr/share/cockpit/$COCKPIT_MODULE/ root@$TEST_SERVER_B:/usr/share/cockpit/$COCKPIT_MODULE-vue/

echo "copying udev rules"
ssh root@$TEST_SERVER_B "cp /usr/share/cockpit/$COCKPIT_MODULE-vue/udev/68-cockpit-45drives-disks.rules /usr/lib/udev/rules.d/68-cockpit-45drives-disks.rules"
