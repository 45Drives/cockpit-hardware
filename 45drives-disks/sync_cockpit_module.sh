...
ssh root@$TEST_SERVER "rm -rf /usr/share/cockpit/$COCKPIT_MODULE-vue"

echo "updating $COCKPIT_MODULE on $TEST_SERVER using rsync..."
rsync -a ./fakeroot/usr/share/cockpit/$COCKPIT_MODULE/ root@$TEST_SERVER:/usr/share/cockpit/$COCKPIT_MODULE-vue/
