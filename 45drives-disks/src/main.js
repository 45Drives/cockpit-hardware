...
import "@45drives/cockpit-css/dist/index.css";
...
const errorHandler = (error) => {
  ...
  if (error instanceof Error && error?.message) {
    ...
    notificationObj.body =
      "An error occured, check the system console (CTRL+SHIFT+J) for more information.";
  }
  if (notificationFIFO.getLen() < 10) notificationFIFO.push(notificationObj);
  else throw error;
};
