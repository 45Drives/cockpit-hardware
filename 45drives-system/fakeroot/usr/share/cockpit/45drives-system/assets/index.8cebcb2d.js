...
const _hoisted_2$5 = { class: "card-header p-5 border-b border-stone-200 dark:border-stone-500 dark:bg-stone-700 sm:flex sm:items-center sm:justify-between" };
const _hoisted_3$4 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-lg leading-6 font-semibold" }, "CPU", -1);
const _hoisted_4$4 = { class: "mt-3 sm:mt-0 sm:ml-4" };
const _hoisted_5$4 = { class: "card-body dark:bg-stone-700" };
const _hoisted_6$4 = {
  key: 0,
...
const _hoisted_10$4 = { class: "min-w-full divide-y divide-stone-400 dark:divide-stone-600" };
const _hoisted_11$4 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-stone-50 dark:bg-stone-500" }, [
...
const _hoisted_12$4 = { class: "divide-y divide-stone-200 bg-white dark:bg-stone-600 dark:divide-stone-500" };
const _hoisted_13$4 = { class: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-stone-900 dark:text-stone-300 sm:pl-6" };
const _hoisted_14$4 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
const _hoisted_15$4 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
const _hoisted_16$4 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
const _hoisted_17$4 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
...
const _hoisted_2$1 = { class: "card-header p-5 border-b border-stone-200 dark:border-stone-500 dark:bg-stone-700 sm:flex sm:items-center sm:justify-between" };
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-lg leading-6 font-semibold" }, "IPMI", -1);
const _hoisted_4 = { class: "mt-3 sm:mt-0 sm:ml-4" };
const _hoisted_5 = { class: "card-body dark:bg-stone-700" };
const _hoisted_6 = {
  key: 0,
  class: "mt-2 flex flex-col"
};
...
const _hoisted_10 = { class: "min-w-full divide-y divide-stone-400 dark:divide-stone-600" };
const _hoisted_11 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-stone-50 dark:bg-stone-500" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", {
      scope: "col",
      class: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-stone-900 dark:text-stone-200 sm:pl-6"
...
const _hoisted_12 = { class: "divide-y divide-stone-200 bg-white dark:bg-stone-600 dark:divide-stone-500" };
const _hoisted_13 = { class: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-stone-900 dark:text-stone-200 sm:pl-6" };
const _hoisted_14 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
const _hoisted_15 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
const _hoisted_16 = { class: "whitespace-nowrap px-3 py-4 text-sm text-stone-500 dark:text-stone-400" };
...
const _hoisted_1$1 = { class: "h-full w-full overflow-y-scroll" };
const _hoisted_2 = { class: "max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8 grow" };
const _sfc_main$1 = {
  setup(__props) {
    return (_ctx, _cache) => {
