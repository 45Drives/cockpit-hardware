import { r as ref, w as watch, a as render, b as render$1, o as openBlock, c as createElementBlock, d as createBaseVNode, n as normalizeStyle, t as toDisplayString, e as createBlock, f as resolveComponent, g as render$2, h as createVNode, F as Fragment, i as renderList, j as createCommentVNode, k as render$3, u as useSpawn, l as createApp } from "./vendor.54cb7d9f.js";
...
const _sfc_main$9 = {
  ...
  setup(props) {
    var _a;
    const darkMode = (_a = props.darkModeInjectionKey) != null ? _a : ref(true);
    function getTheme() {
...
const _hoisted_1$9 = { class: "p-5 flex items-center bg-plugin-header font-redhat shadow-lg z-10" };
const _hoisted_2$8 = { class: "flex flex-row items-baseline basis-32 grow shrink-0" };
...
const _hoisted_6$7 = { class: "flex basis-32 justify-end grow shrink-0" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$9, [
    createBaseVNode("div", _hoisted_2$8, [
      createBaseVNode("img", {
        ...
        src: $setup.darkMode ? "./assets/images/45d-fan-dark.svg" : "./assets/images/45d-fan-light.svg"
      }, null, 8, _hoisted_3$7),
      createBaseVNode("h1", _hoisted_4$7, [
        createBaseVNode("span", {
          class: "text-red-800 dark:text-white font-bold font-source-sans-pro",
          style: normalizeStyle({ "font-size": "1.6rem" })
        }, "45", 4),
        _hoisted_5$7
      ])
    ]),
    ...
    createBaseVNode("div", _hoisted_6$7, [
      createBaseVNode("button", {
        onClick: _cache[1] || (_cache[1] = ($event) => $setup.darkMode = !$setup.darkMode),
        id: "theme-toggle",
        type: "button",
        class: "text-muted focus:outline-none"
      }, [
        $setup.darkMode ? (openBlock(), createBlock(_component_SunIcon, {
          key: 0,
          class: "size-icon-lg"
...
const _hoisted_2$6 = { class: "card-header card-header flex flex-row items-center justify-between" };
const _hoisted_3$5 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-header text-default" }, "System", -1);
const _hoisted_4$5 = { class: "mt-3 sm:mt-0 sm:ml-4" };
const _hoisted_5$5 = { class: "card-body" };
const _hoisted_6$5 = {
  key: 0,
  class: "flex flex-col md:flex-row justify-evenly"
};
const _hoisted_7$5 = { class: "bg-default shadow overflow-hidden sm:rounded-lg" };
const _hoisted_8$5 = { class: "border-b border-default" };
const _hoisted_9$5 = { class: "bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" };
const _hoisted_10$5 = /* @__PURE__ */ createBaseVNode("dt", { class: "text-sm font-medium" }, "Model", -1);
const _hoisted_11$5 = { class: "mt-1 text-sm text-muted sm:mt-0 sm:col-span-2" };
const _hoisted_12$5 = { class: "bg-default px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" };
const _hoisted_13$5 = /* @__PURE__ */ createBaseVNode("dt", { class: "text-sm font-medium" }, "Chassis Size", -1);
const _hoisted_14$5 = { class: "mt-1 text-sm text-muted sm:mt-0 sm:col-span-2" };
const _hoisted_15$5 = { class: "bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" };
const _hoisted_16$5 = /* @__PURE__ */ createBaseVNode("dt", { class: "text-sm font-medium" }, "Serial", -1);
const _hoisted_17$5 = { class: "mt-1 text-sm text-muted sm:mt-0 sm:col-span-2" };
const _hoisted_18$4 = { class: "bg-default px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" };
const _hoisted_19$3 = /* @__PURE__ */ createBaseVNode("dt", { class: "text-sm font-medium" }, "Motherboard", -1);
const _hoisted_20$1 = { class: "mt-1 text-sm text-muted sm:mt-0 sm:col-span-2" };
const _hoisted_21$1 = { class: "bg-accent px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" };
const _hoisted_22 = /* @__PURE__ */ createBaseVNode("dt", { class: "text-sm font-medium" }, " Motherboard Serial ", -1);
const _hoisted_23 = { class: "mt-1 text-sm text-muted sm:mt-0 sm:col-span-2" };
...
const _hoisted_2$5 = { class: "card-header card-header flex flex-row items-center justify-between" };
...
const _hoisted_2$4 = { class: "card-header card-header flex flex-row items-center justify-between" };
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-header text-default" }, "PCI", -1);
const _hoisted_4$3 = { class: "mt-3 sm:mt-0 sm:ml-4" };
const _hoisted_5$3 = { class: "card-body" };
const _hoisted_6$3 = {
  key: 0,
  class: "mt-2 flex flex-col"
};
...
const _hoisted_10$3 = { class: "min-w-full divide-y divide-default" };
const _hoisted_11$3 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-accent" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", {
      scope: "col",
      class: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold sm:pl-6"
...
const _hoisted_12$3 = { class: "divide-y divide-default" };
const _hoisted_13$3 = { class: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-6" };
const _hoisted_14$3 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_15$3 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_16$3 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_17$3 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_18$2 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
...
const _hoisted_2$3 = { class: "card-header card-header flex flex-row items-center justify-between" };
const _hoisted_3$2 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-header text-default" }, "RAM", -1);
...
const _hoisted_10$2 = { class: "min-w-full divide-y divide-default" };
const _hoisted_11$2 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-accent" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", {
      scope: "col",
      class: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold sm:pl-6"
...
const _hoisted_12$2 = { class: "divide-y divide-default bg-default" };
const _hoisted_13$2 = { class: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-6" };
const _hoisted_14$2 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_15$2 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_16$2 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_17$2 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_18$1 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
...
const _hoisted_2$2 = { class: "card-header card-header flex flex-row items-center justify-between" };
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-header text-default" }, "Network", -1);
...
const _hoisted_10$1 = { class: "min-w-full divide-y divide-default" };
const _hoisted_11$1 = /* @__PURE__ */ createBaseVNode("thead", { class: "bg-accent" }, [
  /* @__PURE__ */ createBaseVNode("tr", null, [
    /* @__PURE__ */ createBaseVNode("th", {
      scope: "col",
      class: "py-3.5 pl-4 pr-3 text-left text-sm font-semibold sm:pl-6"
...
const _hoisted_12$1 = { class: "divide-y divide-default bg-default" };
const _hoisted_13$1 = { class: "whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-6" };
const _hoisted_14$1 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_15$1 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_16$1 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_17$1 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_18 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_19 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
const _hoisted_20 = { class: "whitespace-nowrap px-3 py-4 text-sm text-muted" };
...
const _hoisted_2$1 = { class: "card-header card-header flex flex-row items-center justify-between" };
